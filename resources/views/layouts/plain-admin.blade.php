...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/themes/plain/images/favicon.svg')}}" type="image/x-icon" />
    <title>@yield('title')</title>

    <!-- ========== All CSS files linkup ========= -->
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/lineicons.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/fullcalendar.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/fullcalendar.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/themes/plain/css/main.css')}}" />
  </head>
  <body>
    <!-- ======== Preloader =========== -->
    <div id="preloader">
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="{{asset('assets/themes/plain/images/logo/logo.svg')}}" alt="logo" />
        </a>
      </div>
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/lead/lead-6.png')}}" alt="logo" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/lead/lead-1.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/lead/lead-5.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/lead/lead-3.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/lead/lead-2.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Anee Lee</h6>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/profile/profile-image.png')}}" alt="" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{asset('assets/themes/plain/images/profile/profile-image.png')}}" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm">Adam Joe</h4>
                          <a class="text-black/40 hover:text-black text-xs" href="#">Email@gmail.com</a>
                        </div>
                      </div>
                    </li>
                    <li class="divider"></li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="{{asset('assets/themes/plain/images/products/product-mini-1.jpg')}}" alt="" />
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="{{asset('assets/themes/plain/images/products/product-mini-2.jpg')}}" alt="" />
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="{{asset('assets/themes/plain/images/products/product-mini-3.jpg')}}" alt="" />
                            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="{{asset('assets/themes/plain/images/products/product-mini-4.jpg')}}" alt="" />
                            </div>
    ...
    <script src="{{asset('assets/themes/plain/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/themes/plain/js/Chart.min.js')}}"></script>
    <script src="{{asset('assets/themes/plain/js/dynamic-pie-chart.js')}}"></script>
    <script src="{{asset('assets/themes/plain/js/moment.min.js')}}"></script>
    <script src="{{asset('assets/themes/plain/js/fullcalendar.js')}}"></script>
    <script src="{{asset('assets/themes/plain/js/jvectormap.min.js')}}"></script>
    <script src="{{asset('assets/themes/plain//js/world-merc.js')}}"></script>
    <script src="{{asset('assets/themes/plain//js/polyfill.js')}}"></script>
    <script src="{{asset('assets/themes/plain//js/main.js')}}"></script>
